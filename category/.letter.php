...
<section class="">
    ...
    <div class="letter_container">
        <section>
            <div class="letter_title"><?php $this->title() ?></div>
            <span class="word-num" id="word_num"> <?php $this->dateWord('c'); ?></span>
        </section>
 ...
 <?php $this->need('footer.php');?>
  <script>
        ...
        // 文章行数统计，需引入jQuery
        let rowNum = Math.round($("#letter-body").height() / parseFloat($("#letter-body").css('line-height')));
